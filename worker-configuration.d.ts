/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 44e95cf20dead504a576ed26186f182f)
// Runtime types generated with workerd@1.20250924.0 2025-09-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cfw");
	}
	interface Env {
		NODE_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "TURSO_DATABASE_URL" | "TURSO_AUTH_TOKEN">> {}
}
